  ...
  return (
    <div>
      <div className=' font-poppinsFont text-black m-3 '>
        ...
        <button onClick={() => nav('/work/create')} className=' bg-gray-700 text-white h-[2.5rem] w-[8rem] rounded-md text-sm hover:bg-blue-600 mb-4'>Add Content</button>


        <div>
          {Data?.length === 0 ? (
            <div className=' flex justify-center items-center h-[85vh]'>
              <h1 className=' tracking-wider'>No Work Content Found Add Some</h1>
            </div>
          ) : (
                  ...
                  return (
                    <div key={index} className=' flex items-center justify-center flex-col p-3 w-[26rem] h-[15rem] overflow-scroll shadow-shadow1 bg-slate-400 flex-shrink-0'>
                      ...
                      <div className='flex items-center gap-[19rem]'>
                        ...
                        <div className='cursor-pointer' onClick={() => nav(`/work/${i._id}`)}>
